...
func Seed(now time.Time) State {
	...
	state := State{
		...
		Speakers: []Speaker{
			...
			{ID: "spk_lina", FirstName: "Lina", LastName: "Martinez", Email: "lina@example.com", Pronouns: "she/they", Role: "Staff product engineer", Company: "Fathom Tools", Biography: "Lina works on server-first interfaces and interaction models that do not begin with a JavaScript application.", City: "Madrid", CreatedAt: now.Add(-58 * 24 * time.Hour), UpdatedAt: now.Add(-4 * 24 * time.Hour)},
			{ID: "spk_priya", FirstName: "Priya", LastName: "Nair", Email: "priya@example.com", Pronouns: "she/her", Role: "Infrastructure founder", Company: "Needlepoint", Biography: "Priya builds compact retrieval infrastructure for systems that must work at the edge.", City: "Singapore", CreatedAt: now.Add(-55 * 24 * time.Hour), UpdatedAt: now.Add(-18 * time.Hour)},
			{ID: "spk_samira", FirstName: "Samira", LastName: "Haddad", Email: "samira@example.com", Pronouns: "she/her", Role: "Evaluation researcher", Company: "Signal & Measure", Biography: "Samira studies how teams evaluate model and agent behavior under realistic operating constraints.", City: "Toronto", CreatedAt: now.Add(-48 * 24 * time.Hour), UpdatedAt: now.Add(-7 * 24 * time.Hour)},
			...
			{ID: "spk_noor", FirstName: "Noor", LastName: "Al-Sayed", Email: "noor@example.com", Pronouns: "they/them", Role: "Applied AI lead", Company: "Field Notes", Biography: "Noor turns evaluation rubrics into repeatable model-assisted review workflows.", City: "New York", CreatedAt: now.Add(-38 * 24 * time.Hour), UpdatedAt: now.Add(-2 * 24 * time.Hour)},
			{ID: "spk_elliot", FirstName: "Elliot", LastName: "Park", Email: "elliot@example.com", Pronouns: "he/him", Role: "GPU compiler engineer", Company: "Prism Forge", Biography: "Elliot works on practical compiler and GPU paths for teams that prefer Go.", City: "Seoul", CreatedAt: now.Add(-34 * 24 * time.Hour), UpdatedAt: now.Add(-8 * 24 * time.Hour)},
			...
			{ID: "spk_ben", FirstName: "Ben", LastName: "Ito", Email: "ben@example.com", Pronouns: "he/him", Role: "Community programs director", Company: "Open Assembly", Biography: "Ben runs contributor programs and speaker operations for open-source events.", City: "Portland", CreatedAt: now.Add(-24 * 24 * time.Hour), UpdatedAt: now.Add(-20 * time.Hour)},
		},
		Reviewers: []Reviewer{
